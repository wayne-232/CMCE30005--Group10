...
This first-stage report is descriptive. It identifies what changed in the CLUE
data without claiming that COVID-19 caused every change.
...
The code works whether the CSV files are stored in the repository root or in a
`data/` folder.
...
- The next stage should test precinct × industry × business-size patterns using
  multi-year comparison points, rather than year-on-year entry or exit rates.
